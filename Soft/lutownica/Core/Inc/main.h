...
#define SW_TILT_Pin GPIO_PIN_3
#define SW_TILT_GPIO_Port GPIOA
#define PWM_Pin GPIO_PIN_4
#define PWM_GPIO_Port GPIOA
#define Haptic_Pin GPIO_PIN_5
#define Haptic_GPIO_Port GPIOA
#define U_LED_Pin GPIO_PIN_15
#define U_LED_GPIO_Port GPIOA
#define SW_NEXT_Pin GPIO_PIN_3
#define SW_NEXT_GPIO_Port GPIOB
#define SW_SELECT_Pin GPIO_PIN_4
#define SW_SELECT_GPIO_Port GPIOB
#define SW_BACK_Pin GPIO_PIN_5
#define SW_BACK_GPIO_Port GPIOB
#define PS_LED_Pin GPIO_PIN_6
#define PS_LED_GPIO_Port GPIOB
